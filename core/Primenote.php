<?php
/**
 * Classe principal que gerencia Models, Controllers e Views
 *
 * @package primenote
...
class Primenote {
	...
	public function __construct () {
		...
		if ( ! $this->controlador ) {
			...
			// Cria o objeto do controlador "login-controller.php"
			// Este controlador deverá ter uma classe chamada LoginController
