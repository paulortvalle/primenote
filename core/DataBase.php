<?php
/**
 * Classe de Gerenciamento da Base de Dados
 *
 * @package primenote
 * @since 4.0.2 | 22/02/2017 customizada
 */
...
class DataBase {
	...
	/**
	 * Update
	 * Atualiza uma linha da tabela baseada em um campo e valor
	 *
	 * @since 0.1
	 * @access public
	 * @param string $table Nome da tabela
	 * @param string $whereField Nome do campo que deseja atualizar por
	 * @param string $whereFieldValue Valor do campo que deseja atualizar por
